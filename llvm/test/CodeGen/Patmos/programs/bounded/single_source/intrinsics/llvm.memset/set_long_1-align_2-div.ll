; RUN: EXEC_ARGS="0=0 1=50 2=100 5=250"; \
; RUN: %test_execution
; END.
;//////////////////////////////////////////////////////////////////////////////////////////////////
;
...
entry:
  %ptr.0 = alloca i8, i32 51, align 4
  ...
  call void @llvm.memset.p0i8.i32(i8* %ptr, i8 %set_to_i8, i32 50, i1 false)
  br label %for.cond
  
for.cond:
  %i = phi i32 [50, %entry], [%i.decd, %for.body]
...
!0 = !{!0, !1}
!1 = !{!"llvm.loop.bound", i32 50, i32 50}