...
entry:
  %ptr.0 = alloca i8, i32 52, align 4
  ...
  call void @llvm.memset.p0i8.i32(i8* %ptr, i8 %set_to_i8, i32 51, i1 false)
  br label %for.cond
  
for.cond:
  %i = phi i32 [51, %entry], [%i.decd, %for.body]
...
!0 = !{!0, !1}
!1 = !{!"llvm.loop.bound", i32 51, i32 51}