...
entry:
  %ptr = alloca i8, i32 43, align 4
  %set_to_i8 = trunc i32 %set_to to i8
  call void @llvm.memset.p0i8.i32(i8* %ptr, i8 %set_to_i8, i32 43, i1 false)
  br label %for.cond
  
for.cond:
  %i = phi i32 [43, %entry], [%i.decd, %for.body]
...
!0 = !{!0, !1}
!1 = !{!"llvm.loop.bound", i32 43, i32 43}